...
<div class="perm-matrix" data-role="{{ $roleId }}">
	<table class="table table-sm mb-0">
		...
		<tbody>
			@forelse ($modules as $group)
				@include('usermgt::roles.access_controls._perm-row', ['module' => $group, 'isGroup' => true])
				@foreach ($group['children'] ?? [] as $child)
					@include('usermgt::roles.access_controls._perm-row', ['module' => $child, 'isGroup' => false])
				@endforeach
			@empty
				<tr>
